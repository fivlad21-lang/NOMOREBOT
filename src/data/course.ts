...
export const faq = [
  ...
  },
  {
    ...
    a: "Start — лише матеріали, якщо любиш розбиратися сам. Community — ті самі уроки плюс закритий Telegram, де можна скинути екран і спитати людей, хто вже запускав. Mentor — усе попереднє плюс мій особистий супровід: 14 днів у чаті, 2 дзвінки і один повний розбір твого лендінгу.",
  },
  {
    q: "Як я отримаю доступ після оплати?",
    a: "Одразу після успішної оплати відкривається thank-you сторінка, а на email приходить лінк на матеріали. Для Community і Mentor додатково надходить інвайт у Telegram. Якщо листа немає протягом 10–15 хвилин — напиши @notany, розберемо вручну.",
  },
  {
  ...
  },
  {
    ...
    a: "Так, протягом 7 днів після покупки, якщо ти не відкрив більше 20% матеріалів. Пишеш на email або в Telegram — повертаємо. Деталі будуть в оферті на етапі продакшену.",
  },
  {
    q: "Якими способами можна оплатити?",
    a: "Карткою Visa/Mastercard, Apple Pay або Google Pay. Оплата одноразова, без підписки. Зараз на сайті стоїть демо-оплата для перевірки воронки; бойову платіжку підключимо перед запуском трафіку.",
  },
];
